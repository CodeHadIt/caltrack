...
export const DEFAULT_FOODS: Omit<FoodItem, 'id' | 'created_at' | 'user_id'>[] = [
  ...
  { category_id: 'cat-carbs', name: 'Yam', calories_per_100g: 118, protein_per_100g: 1.5, carbs_per_100g: 28, fat_per_100g: 0.2, image_url: 'https://images.unsplash.com/photo-1603052875302-d376b7c0638a?w=200&h=200&fit=crop', is_default: true },
